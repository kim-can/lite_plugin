...
public class LiteFileDialog extends JDialog {
    ...
    private void run(){
        ...
        new CrateFileCodeGenerate(project,psiDirectory,packageName,nameField.getText().trim(),fileList.getSelectedValue(),isSelect,isJava)
                .run(this);
    }
    ...
    public void setBasicInfo(@Nullable Project project, @NotNull PsiDirectory psiDirectory, @NotNull String packageName) {
